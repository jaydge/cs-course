# Week 1 Homework: Getting Comfortable With Your Laptop

Welcome to the course. This week is all about getting comfortable with your laptop, so keep it relaxed. None of this is hard, and none of it is graded on being perfect. Just give each part a real try.

## 1. Practice saving and finding a file

This is the most important one, because you will do it all year.

- Open Finder and go to your Documents.
- Make a new folder and name it "CS Class".
- Open Thonny (or any text app), type a sentence about something you learned in class today, and save it into your "CS Class" folder with a name you will remember.
- Close the app completely.
- Open Finder again and find your file. Open it.

If you can do that without help, you have the most important skill of the whole first month.

## 2. Set up your class accounts (do this with a parent)
