...
That is roughly two hours and forty minutes in total, or just under three if you count the Week 32 triage. It is nowhere near nine, and no amount of recounting the normal sessions will get it there.

**How the gap is covered, and what it is.** The nine hours is a College Board curricular requirement of the course, not a recommendation: by adopting the endorsed syllabus for the audit you attest that the course provides it. It binds only students submitting the Create Task; nobody else needs a minute of it. The course covers the remaining six hours and twenty minutes with a **standing AP hour**: a scheduled, supervised hour immediately after class each week from Week 27 through submission, announced in Week 27 and repeated in every handout since, plus office hours by arrangement for students who miss one. Seven weekly hours plus the in-session blocks clears nine with margin. Keep a dated log of every session and who attended; the log is your audit evidence and the thing to check before anyone presses final submit in Week 32. Verify the current required hours before relying on the figure, since College Board has changed the hour count and the rules around it before.
